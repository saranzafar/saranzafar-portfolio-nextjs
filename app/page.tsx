  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-zinc-900 via-zinc-900 to-black text-white overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mt-16">
            <div className="relative">
              ...
              <div className="relative aspect-square rounded-xl overflow-hidden border border-zinc-800">
                <img
                  src="/full-stack-software-engineer-saran-zafar.jpeg"
                  alt="Saran Zafar"
            ...
            <div className="space-y-6">
              <GlassmorphicCard>
                <p className="text-lg text-zinc-300">
                  I'm a dedicated Full-Stack Software Engineer who loves building great digital products. I'm skilled at making user-friendly websites with React and Next.js, and I'm also good at setting up the backend systems that make them run.
                </p>
                <p className="text-lg text-zinc-300 mt-4">
                  My journey in tech started with a strong interest in solving problems and always learning new things. I've worked with different teams to create digital tools that are easy to use, fast, and work well for everyone.
                </p>
                <p className="text-lg text-zinc-300 mt-4">
                  When I'm not coding, I'm usually looking into new technologies, helping with open-source projects, or just keeping up with what's new in the software world.
                </p>
                <div className="grid grid-cols-2 gap-4 mt-8">
                  <div className="space-y-1">
                    <div className="text-sm text-zinc-500">Name</div>
                    <div className="font-medium">Saran Zafar</div>
                  </div>
                  <div className="space-y-1">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="font-medium">Kotli AJK</div>
                  </div>
                  <div className="space-y-1">
      ...
      <section id="skills" className="py-32 relative">
        ...
        <div className="container relative z-10">
          <SectionHeading title="Technology Stack" subtitle="Tools and technologies I work with" />
      ...
      <section id="blog" className="py-32 relative">
        ...
        <div className="container relative z-10">
          <SectionHeading title="Latest Blog Posts" subtitle="Thoughts, tutorials, and insights" />
